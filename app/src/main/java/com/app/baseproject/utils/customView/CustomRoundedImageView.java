...
/**
 * Created by test(test@gmail.com) on 10/17/16.
 */

public class CustomRoundedImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private ColorStateList borderColor =
            ColorStateList.valueOf(CustomRoundedDrawable.DEFAULT_BORDER_COLOR);
    ...
    public CustomRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (borderColor == null) {
            borderColor = ColorStateList.valueOf(CustomRoundedDrawable.DEFAULT_BORDER_COLOR);
        }
    ...
    public void setImageDrawable(Drawable drawable) {
        mResource = 0;
        mDrawable = CustomRoundedDrawable.fromDrawable(drawable);
        updateDrawableAttrs();
    ...
    public void setImageBitmap(Bitmap bm) {
        mResource = 0;
        mDrawable = CustomRoundedDrawable.fromBitmap(bm);
        updateDrawableAttrs();
        super.setImageDrawable(mDrawable);
    }
    ...
    private Drawable resolveResource() {
        ...
        return CustomRoundedDrawable.fromDrawable(d);
    }
    ...
    private void updateBackgroundDrawableAttrs(boolean convert) {
        if (mutateBackground) {
            if (convert) {
                mBackgroundDrawable = CustomRoundedDrawable.fromDrawable(mBackgroundDrawable);
            }
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof CustomRoundedDrawable) {
            ((CustomRoundedDrawable) drawable).setScaleType(mScaleType)
    ...
    public void setBorderColor(ColorStateList colors) {
        ...
        borderColor = (colors != null) ? colors
                : ColorStateList.valueOf(CustomRoundedDrawable.DEFAULT_BORDER_COLOR);
        updateDrawableAttrs();
        updateBackgroundDrawableAttrs(false);
        if (borderWidth > 0) {
